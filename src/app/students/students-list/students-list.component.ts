...
export class StudentsListComponent implements AfterViewInit{
    ...
    columnsToDisplay: string[] = ['select',  'studentSchoolId', 'firstName', 'lastName', 'studentEmail', 'editDelete'];
        ...
        merge(this.sort.sortChange)
            .pipe(
                ...
                switchMap(() => { // switches the MatSort or MatPaginator observable to a StudentsList observable
                    ...
                    return this.studentsHttpClient.getStudents(this.sort.active, this.sort.direction,this.tableFilters);
                }),
    ...
    masterToggle() {
        if (this.isAllSelected()) {
            ...
            this.isProcessing = true;
            this.studentsHttpClient.getStudents(this.sort.active, this.sort.direction, this.tableFilters)
                .pipe(
